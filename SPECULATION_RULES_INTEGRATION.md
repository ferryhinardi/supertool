...
**Files:**
- `docs/SPECULATION_RULES.md` - Complete guide (508 lines)
- `docs/SPECULATION_RULES_QUICKSTART.md` - Quick start guide (160 lines)
...
- 📖 [Complete Documentation](./docs/SPECULATION_RULES.md)
- 🚀 [Quick Start Guide](./docs/SPECULATION_RULES_QUICKSTART.md)
...
- 📝 Full documentation in `docs/SPECULATION_RULES.md`

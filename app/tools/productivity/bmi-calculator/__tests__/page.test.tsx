...
describe('BMI Calculator Page', () => {
  ...
  describe('Pro Tips Section', () => {
    ...
    it('should display tip about unit switching', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Switch between metric and imperial units/i)).toBeTruthy()
    })

    it('should display tip about history saving', () => {
      render(<BMICalculatorPage />)
      const historyElements = screen.getAllByText(
        /Your calculation history is automatically saved/i
      )
      expect(historyElements.length).toBeGreaterThanOrEqual(1)
    })

    it('should display tip about exporting', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Export your results as JSON/i)).toBeTruthy()
    })
  })
  ...
  describe('How to Use Section', () => {
    it('should render How to Use heading', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/How to Use BMI Calculator/i)).toBeTruthy()
    })

    it('should display step 1: Choose unit system', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Choose your unit system/i)).toBeTruthy()
    })

    it('should display step 2: Enter measurements', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Enter your measurements/i)).toBeTruthy()
    })

    it('should display step 3: Calculate and view', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Calculate and view results/i)).toBeTruthy()
    })

    it('should display step 4: Review recommendations', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Review health recommendations/i)).toBeTruthy()
    })

    it('should display step 5: Track progress', () => {
      render(<BMICalculatorPage />)
  ...
  describe('FAQ Section', () => {
    it('should render FAQ about what BMI is', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/What is BMI and how is it calculated/i)).toBeTruthy()
    })

    it('should render FAQ about accuracy', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/How accurate is BMI for assessing health/i)).toBeTruthy()
    })

    it('should render FAQ about categories', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/What do the different BMI categories mean/i)).toBeTruthy()
    })

    it('should render FAQ about children', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Can I use this calculator for children and teenagers/i)).toBeTruthy()
    })

    it('should render FAQ about athletes', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Is BMI accurate for athletes and bodybuilders/i)).toBeTruthy()
    })

    it('should render FAQ about healthy weight', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/What is a healthy weight range for my height/i)).toBeTruthy()
    })

    it('should render FAQ about concerns', () => {
      render(<BMICalculatorPage />)
      expect(
        screen.getByText(/Should I be concerned if my BMI is outside the normal range/i)
      ).toBeTruthy()
    })

    it('should render FAQ about body fat', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/How does BMI relate to body fat percentage/i)).toBeTruthy()
    })

    it('should render FAQ about tracking', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/Can I track my BMI changes over time/i)).toBeTruthy()
    })

    it('should render FAQ about changing BMI', () => {
      render(<BMICalculatorPage />)
      expect(screen.getByText(/What should I do if I want to change my BMI/i)).toBeTruthy()
    })
  })

...
export default function ResumeBuilderPage() {
  ...
  // Activate sticky behavior when preview section scrolls past viewport
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        // When preview section leaves viewport (top), activate sticky
        setIsSidebarSticky(!entry.isIntersecting)
      },
      {
        threshold: 0,
        rootMargin: '-1px 0px 0px 0px', // Trigger when top edge crosses viewport top
      }
    )
      ...
      >
        ...
        <aside
          ...
          className={css({
            ...
            position: isSidebarSticky ? 'sticky' : 'relative',
            top: isSidebarSticky ? '4' : undefined,
            alignSelf: 'start',

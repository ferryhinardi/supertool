...
export default function SvgToPngConverter() {
  ...
  return (
    ...
    >
        ...
        >
          <div className={css({ spaceY: '3' })}>
            <div className={css({ display: 'flex', alignItems: 'start', gap: '3' })}>
              ...
              <div>
                <h3 className={css({ fontWeight: 'semibold', color: 'white', mb: '1' })}>
                  Upload SVG File
                </h3>
                <p className={css({ fontSize: 'sm', color: 'gray.400' })}>
                  Click the upload area to select an SVG file from your device (max 10MB)
                </p>
              </div>
            </div>
          </div>
          <div className={css({ spaceY: '3' })}>
            <div className={css({ display: 'flex', alignItems: 'start', gap: '3' })}>
              ...
              <div>
                ...
                <p className={css({ fontSize: 'sm', color: 'gray.400' })}>
                  Adjust dimensions, background color, and quality to your preferences
                </p>
              </div>
            </div>
          </div>
          <div className={css({ spaceY: '3' })}>
            <div className={css({ display: 'flex', alignItems: 'start', gap: '3' })}>
              ...
              <div>
                ...
                <p className={css({ fontSize: 'sm', color: 'gray.400' })}>
                  Click "Convert to PNG" to generate your PNG image
                </p>
              </div>
            </div>
          </div>
          <div className={css({ spaceY: '3' })}>
            <div className={css({ display: 'flex', alignItems: 'start', gap: '3' })}>
              ...
              <div>
                ...
                <p className={css({ fontSize: 'sm', color: 'gray.400' })}>
                  Download the PNG file or copy it directly to your clipboard
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <h2 className={css({ fontSize: '2xl', fontWeight: 'bold', color: 'white', mb: '6' })}>
          Key Features
        </h2>
        <div
          className={css({
          ...
          {[
            {
              ...
              description: 'Set exact width and height up to 4096px',
            },
            {
              title: 'Aspect Ratio',
              description: 'Maintain or adjust aspect ratio as needed',
            },
            {
              title: 'Background Colors',
              description: 'Choose transparent or custom background colors',
            },
            {
              title: 'Quality Control',
              description: 'Adjust PNG quality from 10% to 100%',
            },
            {
              title: 'Instant Download',
              description: 'Download converted PNG files immediately',
            },
            {
              title: 'Copy to Clipboard',
              description: 'Copy PNG images directly to clipboard',
            },
          ].map((feature) => (
            <div key={feature.title} className={css({ spaceY: '2' })}>
              <h3 className={css({ fontWeight: 'semibold', color: 'white' })}>{feature.title}</h3>

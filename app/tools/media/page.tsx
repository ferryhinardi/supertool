...
import { ArrowLeft, ArrowRight, Image, Sparkles, Star, TrendingUp } from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image className={css({ h: '10', w: '10', color: 'white' })} />
        </div>
        ...
        >
          Optimize, convert, and enhance your media files with {categoryTools.length} free online
          tools.
        </p>

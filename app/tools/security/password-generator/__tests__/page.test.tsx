...
describe('Password Generator - Security Notice', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })

  it('displays security notice section', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText('Security & Privacy Notice')).toBeInTheDocument()
  })

  it('mentions cryptographically secure generation', () => {
    render(<PasswordGeneratorPage />)
  ...
  it('mentions browser-only generation', () => {
    render(<PasswordGeneratorPage />)
...
describe('Password Generator - FAQ Section', () => {
  beforeEach(() => {
    vi.clearAllMocks()
  })
  ...
  it('displays FAQ section', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/How secure are the passwords/i)).toBeInTheDocument()
  })

  it('includes diceware explanation', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/What is a diceware passphrase/i)).toBeInTheDocument()
  })

  it('includes HIBP explanation', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/What is the.*Have I Been Pwned.*check/i)).toBeInTheDocument()
  })

  it('includes unique passwords advice', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/Should I use different passwords/i)).toBeInTheDocument()
  })

  it('explains bulk generation', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/What is the bulk password generation feature/i)).toBeInTheDocument()
  })

  it('explains templates', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/How do I use the password templates/i)).toBeInTheDocument()
  })

  it('explains entropy', () => {
    render(<PasswordGeneratorPage />)
    expect(screen.getByText(/What is password entropy/i)).toBeInTheDocument()
  })
})

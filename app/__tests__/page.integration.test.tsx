...
// Create simple SVG mocks with data-testid for testing
vi.mock('lucide-react', () => {
  // biome-ignore lint/suspicious/noExplicitAny: Mock icon factory requires any
  const createMockIcon = (name: string) => {
    const MockIcon = React.forwardRef<SVGSVGElement, { className?: string }>((props, ref) => {
  ...
  // List all icons used in the application - includes icons from lib/data/tools.ts
  const iconNames = [
    // Icons from lib/data/tools.ts (exact imports)
    'Activity',
    'BarChart3',
    'BookOpen',
    'Bot',

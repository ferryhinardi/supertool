...
4. **Review testing guide**: `docs/POLAR_PAYMENT_TESTING_GUIDE.md`
5. **Review troubleshooting**: `docs/POLAR_PAYMENT_TESTING_GUIDE.md#troubleshooting`

---

**Last Updated**: December 25, 2025  
**Related Docs**:
- `docs/POLAR_ENV_SETUP_GUIDE.md` - Local environment setup
- `docs/POLAR_PAYMENT_TESTING_GUIDE.md` - Testing procedures

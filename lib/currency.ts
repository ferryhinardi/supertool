...
export const CURRENCIES: Currency[] = [
  ...
  { code: 'NZD', symbol: 'NZ$', name: 'New Zealand Dollar', iconName: 'CircleDollarSign' },
  ...
  { code: 'LBP', symbol: '£', name: 'Lebanese Pound', iconName: 'PoundSterling' },

  // Africa
  { code: 'ZAR', symbol: 'R', name: 'South African Rand', iconName: 'Banknote' },
  { code: 'EGP', symbol: '£', name: 'Egyptian Pound', iconName: 'PoundSterling' },
  ...
  { code: 'MAD', symbol: 'د.م.', name: 'Moroccan Dirham', iconName: 'Banknote' },
  { code: 'TND', symbol: 'د.ت', name: 'Tunisian Dinar', iconName: 'Banknote' },
  { code: 'UGX', symbol: 'USh', name: 'Ugandan Shilling', iconName: 'Banknote' },
  { code: 'TZS', symbol: 'TSh', name: 'Tanzanian Shilling', iconName: 'Banknote' },
  ...
  { code: 'HKD', symbol: 'HK$', name: 'Hong Kong Dollar', iconName: 'DollarSign' },
  ...
  { code: 'MOP', symbol: 'MOP$', name: 'Macanese Pataca', iconName: 'DollarSign' },
  { code: 'KZT', symbol: '₸', name: 'Kazakhstani Tenge', iconName: 'Banknote' },
  { code: 'UZS', symbol: "so'm", name: 'Uzbekistani Som', iconName: 'Banknote' },
  { code: 'MNT', symbol: '₮', name: 'Mongolian Tugrik', iconName: 'Banknote' },

  // Additional Americas
  { code: 'UYU', symbol: '$U', name: 'Uruguayan Peso', iconName: 'DollarSign' },
  { code: 'BOB', symbol: 'Bs', name: 'Bolivian Boliviano', iconName: 'Banknote' },
  { code: 'PYG', symbol: '₲', name: 'Paraguayan Guarani', iconName: 'Banknote' },
  { code: 'CRC', symbol: '₡', name: 'Costa Rican Colón', iconName: 'Coins' },
  { code: 'GTQ', symbol: 'Q', name: 'Guatemalan Quetzal', iconName: 'Banknote' },
  { code: 'HNL', symbol: 'L', name: 'Honduran Lempira', iconName: 'Banknote' },
  { code: 'NIO', symbol: 'C$', name: 'Nicaraguan Córdoba', iconName: 'DollarSign' },
  { code: 'PAB', symbol: 'B/.', name: 'Panamanian Balboa', iconName: 'Banknote' },
  { code: 'DOP', symbol: 'RD$', name: 'Dominican Peso', iconName: 'DollarSign' },
  { code: 'JMD', symbol: 'J$', name: 'Jamaican Dollar', iconName: 'DollarSign' },
  { code: 'TTD', symbol: 'TT$', name: 'Trinidad and Tobago Dollar', iconName: 'DollarSign' },
  { code: 'BBD', symbol: 'Bds$', name: 'Barbadian Dollar', iconName: 'DollarSign' },
  { code: 'BSD', symbol: 'B$', name: 'Bahamian Dollar', iconName: 'DollarSign' },
  ...
  { code: 'MKD', symbol: 'ден', name: 'Macedonian Denar', iconName: 'Banknote' },
  { code: 'BAM', symbol: 'KM', name: 'Bosnia-Herzegovina Convertible Mark', iconName: 'Banknote' },
  ...
  { code: 'MZN', symbol: 'MT', name: 'Mozambican Metical', iconName: 'Banknote' },
  { code: 'ZMW', symbol: 'ZK', name: 'Zambian Kwacha', iconName: 'Banknote' },
  { code: 'BWP', symbol: 'P', name: 'Botswanan Pula', iconName: 'Banknote' },
  { code: 'NAD', symbol: 'N$', name: 'Namibian Dollar', iconName: 'DollarSign' },
  ...
  { code: 'DJF', symbol: 'Fdj', name: 'Djiboutian Franc', iconName: 'Banknote' },
  { code: 'SCR', symbol: '₨', name: 'Seychellois Rupee', iconName: 'Banknote' },
  { code: 'GMD', symbol: 'D', name: 'Gambian Dalasi', iconName: 'Banknote' },
  { code: 'SLL', symbol: 'Le', name: 'Sierra Leonean Leone', iconName: 'Banknote' },
  { code: 'LRD', symbol: 'L$', name: 'Liberian Dollar', iconName: 'DollarSign' },
  ...
  { code: 'TJS', symbol: 'ЅМ', name: 'Tajikistani Somoni', iconName: 'Banknote' },
  { code: 'KGS', symbol: 'с', name: 'Kyrgyzstani Som', iconName: 'Banknote' },
  { code: 'TMT', symbol: 'T', name: 'Turkmenistani Manat', iconName: 'Banknote' },

  // Additional Asia-Pacific
  { code: 'FJD', symbol: 'FJ$', name: 'Fijian Dollar', iconName: 'DollarSign' },
  { code: 'PGK', symbol: 'K', name: 'Papua New Guinean Kina', iconName: 'Banknote' },
  ...
  { code: 'SBD', symbol: 'SI$', name: 'Solomon Islands Dollar', iconName: 'DollarSign' },

  // Special Administrative Regions & Territories
  { code: 'XCD', symbol: 'EC$', name: 'East Caribbean Dollar', iconName: 'DollarSign' },
  { code: 'XOF', symbol: 'CFA', name: 'West African CFA Franc', iconName: 'Banknote' },
  { code: 'XAF', symbol: 'FCFA', name: 'Central African CFA Franc', iconName: 'Banknote' },

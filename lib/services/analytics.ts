...
export type ToolEvent =
  ...
  | 'social_resizer_upload'
  | 'social_resizer_clear'
  | 'social_resizer_preset_toggle'
  | 'social_resizer_resize'
  | 'social_resizer_download_single'
  | 'social_resizer_download_zip'
  | 'social_resizer_preview'
  | 'social_resizer_error'
  | 'ai_caption_open'
  | 'ai_caption_upload'
  | 'ai_caption_generate'
  | 'ai_caption_copy'
  ...
  | 'image_to_text_upload'
  | 'image_to_text_success'
  | 'image_to_text_error'
  | 'image_to_text_copy'
  | 'image_to_text_download'
  | 'image_to_text_clear'
  | 'tool_search_open'
  | 'tool_search_select'
  ...
  | 'email_templates_open'
  | 'email_templates_select'
  | 'email_templates_category'
  | 'email_templates_copy'
  | 'email_templates_copy_body'
  | 'email_templates_save'
  | 'email_templates_delete'
  | 'email_templates_download'
  | 'budget_planner_open'
  | 'budget_planner_calculate'
  | 'budget_planner_income_change'
  | 'budget_planner_add_expense'
  | 'budget_planner_remove_expense'
  | 'budget_planner_save'
  | 'budget_planner_load'
  | 'budget_planner_delete'
  | 'budget_planner_export'
  | 'budget_planner_reset'
  | 'meeting_notes_open'
  | 'meeting_notes_generate'
  | 'meeting_notes_template_select'
  | 'meeting_notes_copy'
  | 'meeting_notes_export'
  | 'meeting_notes_save'
  | 'meeting_notes_load'
  | 'meeting_notes_delete'
  | 'meeting_notes_ai_assist'
  | 'meeting_notes_share'
  | 'work_hours_open'
  | 'work_hours_calculate'
  | 'work_hours_add_entry'
  | 'work_hours_remove_entry'
  | 'work_hours_save'
  | 'work_hours_load'
  | 'work_hours_delete'
  | 'work_hours_export'
  | 'work_hours_copy'
  | 'work_hours_clear'
  | 'work_hours_timer_start'
  | 'work_hours_timer_stop'
  | 'expense_tracker_open'
  | 'expense_tracker_add'
  | 'expense_tracker_edit'
  | 'expense_tracker_delete'
  | 'expense_tracker_filter'
  | 'expense_tracker_export'
  | 'expense_tracker_import'

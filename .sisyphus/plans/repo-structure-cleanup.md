...
- [ ] 1. Fix .gitignore — clean up garbled entries, add missing ignores, fix turbopack typo
...
- [ ] 2. Remove bin/ffmpeg from git tracking and update references
...
- [ ] 3. Remove styled-system/ and app/panda.css from git tracking
...
- [ ] 4. Move TOOL_PAGE_TEMPLATE.tsx to scripts/templates/ and update all references
...
- [ ] 5. Move SpeculationRules.tsx to components/features/
...
- [ ] 6. Move types/ contents to lib/types/
...
- [ ] 7. Consolidate test-utils/userEvent.ts
...
- [ ] 8. Move root shell scripts to scripts/
...
- [ ] 9. Clean up root-level temp/debug files
...
- [ ] All 9 commits made atomically (build passes after each)
